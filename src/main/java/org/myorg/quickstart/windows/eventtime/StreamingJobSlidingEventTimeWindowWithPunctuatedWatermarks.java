...
/**
 * See explanation image of this program in <b>docs/windows-sliding-event-time-window-with-punctuated-watermarks.png</b>.
 *
 * <b>Sliding windows useful documentation:</b>
 * <li>https://ci.apache.org/projects/flink/flink-docs-stable/dev/stream/operators/windows.html#sliding-windows</li>
 * <br>
 ...
 */
public class StreamingJobSlidingEventTimeWindowWithPunctuatedWatermarks {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Event> dataStream = env.fromElements(
                // a
                Event.builder().key("a").value(1).timestamp(5L).build(),
                Event.builder().key("a").value(2).timestamp(6L).build(),
                Event.builder().key("a").value(3).timestamp(7L).build(),
                Event.builder().key("a").value(4).timestamp(8L).build()
        );
        //endregion
        ...
        //region Group events with the same key into windows of 4 milliseconds that slides by 2 milliseconds
        WindowedStream<Event, String, TimeWindow> windowedDataStream = dataStreamWithTimestampsAndWatermarks
                ...
                // Sliding event time window of 4 milliseconds that slides by 2 milliseconds
                .window(SlidingEventTimeWindows.of(
                        Time.milliseconds(4), // window size
                        Time.milliseconds(2)  // window slide
                ))
        ...
        env.execute("Flink Streaming Job (SlidingEventTimeWindowWithPunctuatedWatermarks example)");
        //endregion
    }
